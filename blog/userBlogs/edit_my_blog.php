...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input class="form-control" id="post_author" type="text" placeholder="Post Author" name="post_author" required value="<?php echo $post_author; ?>" disabled/>
            ...
            <div class="form-floating mb-3">
              ...
              <div class="row g-2">
                <div class="col-md">
                    <img class="image-fluid" src="../image/<?php echo $post_image; ?>" alt="no_img_uploaded_before" style="height: 100px; width:150px;">
...
?>
                ...
                <div class="col-md mt-4">
                  <div class="form-floating">
                    ...
                    <option value="<?php echo $_GET['post_stat']; ?>" selected><?php echo $_GET['post_stat']; ?></option>                  
                    </select>
